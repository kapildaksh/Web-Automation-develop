...
import com.prenetics.swagger.testing.handler.StepsApi;
...
public class StepsApiTest {
     ...
     */
    @Test
    public void shouldSee201AfterDeleteSteps() {
        StepReset body = null;
        api.deleteSteps()
     ...
     */
    @Test
    public void shouldSee400AfterDeleteSteps() {
        StepReset body = null;
        api.deleteSteps()
                .body(body).execute(r -> r.prettyPeek());
        // TODO: test validations
     ...
     */
    @Test
    public void shouldSee500AfterDeleteSteps() {
        StepReset body = null;
        api.deleteSteps()
                .body(body).execute(r -> r.prettyPeek());
        // TODO: test validations
