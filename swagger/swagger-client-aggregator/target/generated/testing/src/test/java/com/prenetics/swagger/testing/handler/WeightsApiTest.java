...
import com.prenetics.swagger.testing.handler.WeightsApi;
...
/**
 * API tests for WeightsApi
 */
@Ignore
public class WeightsApiTest {
     ...
     */
    @Test
    public void shouldSee201AfterDeleteWeights() {
        WeightReset body = null;
        api.deleteWeights()
     ...
     */
    @Test
    public void shouldSee400AfterDeleteWeights() {
        WeightReset body = null;
        api.deleteWeights()
                .body(body).execute(r -> r.prettyPeek());
        // TODO: test validations
     ...
     */
    @Test
    public void shouldSee500AfterDeleteWeights() {
        WeightReset body = null;
        api.deleteWeights()
                .body(body).execute(r -> r.prettyPeek());
        // TODO: test validations
