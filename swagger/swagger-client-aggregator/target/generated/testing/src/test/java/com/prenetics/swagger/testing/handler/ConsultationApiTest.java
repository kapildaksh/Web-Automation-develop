...
import com.prenetics.swagger.testing.handler.ConsultationApi;
...
public class ConsultationApiTest {
     ...
     */
    @Test
    public void shouldSee204AfterUpdateConsultation() {
        String account = null;
        ConsultationRequest body = null;
     ...
     */
    @Test
    public void shouldSee400AfterUpdateConsultation() {
        String account = null;
        ConsultationRequest body = null;
        api.updateConsultation()
                .accountPath(account)
     ...
     */
    @Test
    public void shouldSee500AfterUpdateConsultation() {
        String account = null;
        ConsultationRequest body = null;
        api.updateConsultation()
                .accountPath(account)
